export const elEquation = document.getElementById("equation");
export const elAnswer = document.getElementById("answer");
...
export const opSelect = document.getElementById("opSelect");
export const maxResultInput = document.getElementById("maxResult");
export const maxXInput = document.getElementById("maxX");
...
export const varietyToggle = document.getElementById("varietyToggle");
